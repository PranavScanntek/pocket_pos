...
import 'package:pocket_pos/screens/mobileView/dash/profile/profile_screen.dart';
    ...
    return Scaffold(
      ...
      body: SingleChildScrollView(
              child: Padding(
                ...
                SizedBox(height: size?.hp(1),),
                HintText(text: 'Email ID',textSize: 0.031),
                TextContainer(
                color: theme.scaffoldBackgroundColor,
                child: TextFormField(
                ...
                SizedBox(height: size?.hp(1),),
                HintText(text: 'Address',textSize: 0.031),
                TextContainer(
                color: theme.scaffoldBackgroundColor,
                child: TextFormField(
                ...
                crossAxisAlignment:CrossAxisAlignment.start,
                children: [
                HintText(text: 'City',textSize: 0.031),
                TextContainer(
                  width: size?.wp(43),
                color: theme.scaffoldBackgroundColor,
                child: TextFormField(
                ...
                crossAxisAlignment:CrossAxisAlignment.start,
                children: [
                HintText(text: 'ZIP/postcode',textSize: 0.031),
                TextContainer(
                  width: size?.wp(43),
                color: theme.scaffoldBackgroundColor,
                child: TextFormField(
                ...
                SizedBox(height: size?.hp(1),),
                HintText(text: 'Mobile number',textSize: 0.031),
                Container(
                  height: size?.hp(6),
                width: double.infinity,
                padding: EdgeInsets.symmetric(horizontal: 12),
                ...
                border: InputBorder.none,
                  ...
                  SizedBox(height: size?.hp(1),),
                  HintText(text: 'Land-phone number',textSize: 0.031),
                  TextContainer(
                    color: theme.scaffoldBackgroundColor,
                    child: TextFormField(
                      keyboardType: TextInputType.number,
                ...
                SizedBox(height: size?.hp(1),),
                HintText(text: 'UPI id',textSize: 0.031),
                TextContainer(
                color: theme.scaffoldBackgroundColor,
                child: Row(
                children: [
                ...
                SizedBox(height: size?.hp(1),),
                HintText(text:(currencyNotifier.selectedCountry == 'India')?'GST number':'TRN number',textSize: 0.031),
                TextContainer(
                color: theme.scaffoldBackgroundColor,
                child: TextFormField(
                ...
                SizedBox(height: size?.hp(1),),
                HintText(text: 'Accepting currency',textSize: 0.031),
                Padding(
