...
import 'package:pocket_pos/screens/mobileView/dash/home/payment/payment_screen2.dart';
                  ...
                  child: Column(
                    children: [
                      ...
                      Row(
                        mainAxisAlignment: MainAxisAlignment.center,
                        children: [
                          AuthButton(textSize: 0.035,text: 'Cancel', action: (){}, textColor: theme.primaryColor, boxColor: theme.highlightColor, width: size!.wp(28)),
                          SizedBox(width: size?.wp(3),),
                          AuthButton(textSize: 0.035,text: 'Done', action: (){}, textColor: theme.highlightColor, boxColor: theme.primaryColor, width: size!.wp(28))
                        ],
                      )
                    ],
                  ),
