...
class _ProductEditScreenState extends State<ProductEditScreen> {
    ...
    child: Padding(
      ...
      children: [
          ...
          HintText(text: 'Barcode',textSize: 0.031),
          TextContainer(
      ...
      SizedBox(height: size?.hp(2),),
      HintText(text: 'Product name',textSize: 0.031),
      TextContainer(
      color: theme.scaffoldBackgroundColor,
      child: TextFormField(
      ...
      SizedBox(height: size?.hp(2),),
      HintText(text: 'Product category',textSize: 0.031),
      Row(
      mainAxisAlignment: MainAxisAlignment.spaceBetween,
      children: [
      Expanded(
      ...
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
      HintText(text: 'Product Price',textSize: 0.031),
      TextContainer(
      color: theme.scaffoldBackgroundColor,
      child: TextFormField(
      ...
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
      HintText(text: 'Selling Price',textSize: 0.031),
      TextContainer(
      color: theme.scaffoldBackgroundColor,
      child: TextFormField(
        keyboardType: TextInputType.number,
      ...
      SizedBox(height: size?.hp(2),),
      HintText(text: 'Stock count',textSize: 0.031),
      Container(
      width: size?.wp(42),
      child: TextContainer(
      color: theme.scaffoldBackgroundColor,
      ...
      SizedBox(height: size?.hp(2),),
          HintText(text: 'Tax rate',textSize: 0.031),
