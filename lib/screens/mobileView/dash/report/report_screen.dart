                      ...
                      Row(
                        ...
                        children: [
                          InkWell(
                              ...
                              child: TimeContainer(text: 'Cash', boxColor: hasCash?theme.primaryColor:theme.focusColor, textColor: hasCash?theme.highlightColor:theme.indicatorColor, textSize: 0.035,)),
                          InkWell(
                              onTap:() {
                                setState(() {
                              ...
                              child: TimeContainer(text: 'Google pay', boxColor: hasGpay?theme.primaryColor:theme.focusColor, textColor: hasGpay?theme.highlightColor:theme.indicatorColor,textSize: 0.035)),
                          InkWell(
                              onTap:() {
                                setState(() {
                              ...
                              child: TimeContainer(text: 'Credit card', boxColor: hasCreditCard?theme.primaryColor:theme.focusColor, textColor: hasCreditCard?theme.highlightColor:theme.indicatorColor,textSize: 0.035)),
                          ...
                          InkWell(
                              ...
                              child: TimeContainer(text: 'Credit', boxColor: hasCredit?theme.primaryColor:theme.focusColor, textColor: hasCredit?theme.highlightColor:theme.indicatorColor,textSize: 0.035)),
                        ],
                      ),
                      ...
                      children: [
                        InkWell(
                          ...
                          child: TimeContainer(
                              ...
                              textColor: _hasGst?theme.highlightColor:theme.indicatorColor,textSize: 0.035),
                        ),
                        SizedBox(width: size?.wp(3),),
                        InkWell(
                          onTap: (){
                          ...
                          child: TimeContainer(
                              ...
                              textColor: _hasTax?theme.highlightColor:theme.indicatorColor,textSize: 0.035),
                        ),
                      ],
                    ),
                  ),
