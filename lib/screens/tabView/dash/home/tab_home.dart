...
class _TabHomeScreenState extends State<TabHomeScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    final List<Product>? selectedProducts=selectedProduct;
                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  InkWell(
                                    onTap: (){
                                      setState(() {
                                        if(hasBag==true&&hasBagItems==false){
                                          return null;
                                        }else {
          ...
          Expanded(
              child: Column(
                ...
                children: [
                  ...
                  Column(
                    children: [
                      if(hasBag==false&&hasBagItems==false)
                      Container(
                        height:size?.hp(80),
                        child: Column(
                          children: [
                                                    ...
                                                    actions: [
                                                      Row(
                                                        ...
                                                        children: [
                                                          AuthButton(text: 'Cancel', action: (){
                                                            Navigator.pop(context);
                                                          }, textSize: 0.035,textColor: theme.primaryColor, boxColor: theme.scaffoldBackgroundColor, width: size!.wp(23)),
                                                          ...
                                                          AuthButton(text: 'Done', action: (){
                                                            ...
                                                            Navigator.pop(context);
                                                          },textSize: 0.035, textColor: theme.highlightColor, boxColor: theme.primaryColor, width:size!.wp(23))
                                                        ],
                                                      )
                                                    ],
                                                  );
                            ...
                            children: [
                              ...
                              Center(child: Text('No data',style: TextStyle(color: theme.indicatorColor),))
                                  :Container(
                                    ...
                                    child: ListView.builder(
                                        shrinkWrap: true,
                                        itemCount: enteredNames.length,
                                        itemBuilder: (context,index){
                                          return Padding(
                                            padding: const EdgeInsets.symmetric(vertical: 10),
                                            child: ListTile(
                                              tileColor: hasBagItems==true?Color.fromRGBO(255, 43, 133, 0.19):theme.scaffoldBackgroundColor,
                                              title: Text('${enteredNames[index]}'),
                                              onTap: (){
                                                setState(() {
                                                  hasBagItems=true;
                                                  hasBag=false;
                      ...
                      if(hasBag==false&&hasBagItems==true)
                        Container(
                          height:size?.hp(80),
                          child: selectedProducts==null?
                          Center(child: Text('No data',style: TextStyle(color: theme.indicatorColor),))
                         :
                          Column(
                            children: [
