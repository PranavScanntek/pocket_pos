...
class TabAddProduct extends StatefulWidget {
  const TabAddProduct({super.key});

  @override
  State<TabAddProduct> createState() => _TabAddProductState();
}

class _TabAddProductState extends State<TabAddProduct> {
  Screen ? size;
